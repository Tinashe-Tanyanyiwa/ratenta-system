...
const BaleDetail: React.FC = () => {
  ...
  const generateBarcode = (code: string) => {
    ...
    JsBarcode(barcodeElement, code, {
      format: "CODE39", // You can choose a different format if needed
      displayValue: true,
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <Badge
                  variant={
                    bale.status === "published" ? "default" : "secondary"
                  }
                >
                  {bale.status}
                </Badge>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Created{" "}
                {bale.date_created
                  ? new Date(bale.date_created).toLocaleDateString()
                  : "Unknown"}
              </p>
            </div>
          </div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Are you sure you want to delete this bale? This action
                    cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">
                  {bale.date ? new Date(bale.date).toLocaleDateString() : "—"}
                </p>
              </div>
            </div>
            ...
            {bale.has_fault && (
              <>
                ...
                <div className="p-4 rounded-lg bg-warning/10 border border-warning/30">
                  ...
                  <p className="text-sm">
                    {bale.fault_description || "No description provided"}
                  </p>
                </div>
              </>
            )}
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {bale.date_created
                        ? new Date(bale.date_created).toLocaleString()
                        : "Unknown"}
                    </p>
                  </div>
                </div>
